  ...
  return (
    <section className="rounded-[24px] border bg-card p-5 shadow-sm sm:p-6">
      <div className="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <h2 className="text-lg font-black tracking-tight">AI usage</h2>
        ...
        {!usage.pro_entitled && (
          <p className="text-sm font-semibold text-[#8d382d]">Pro required for AI and voice</p>
        )}
      </div>
      ...
      <div className="mt-5 space-y-4">
        <div>
          ...
          <div
            ...
            aria-valuenow={aiPct}
          >
            <div className="h-full rounded-full bg-[#ff6b55] transition-all" style={{ width: `${aiPct}%` }} />
          </div>
        ...
        <div>
          <div className="mb-2 flex items-center justify-between gap-3 text-sm">
            <span className="font-semibold">Voice usage</span>
          ...
          >
            <div className="h-full rounded-full bg-[#9dbb63] transition-all" style={{ width: `${voicePct}%` }} />
          </div>
        </div>
      </div>

      <details className="mt-5 rounded-2xl border bg-[#fffdf8] p-4">
        <summary className="cursor-pointer text-sm font-bold text-[#183a32] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff6b55]">
          How usage works
        </summary>
        <div className="mt-3 space-y-2 text-sm leading-6 text-[#557067]">
          <p>AI usage covers generating a new invoice draft and asking AI to update an existing draft. Longer instructions use more of your monthly allowance.</p>
          <p>Voice usage covers transcription time. Keep clips short for best results.</p>
          <p>Your plan’s included AI and voice reset each billing period and do not roll over. Top-up packs you buy roll until they are used, but only while Pro is active. If Pro ends, top-ups freeze and return when you resubscribe.</p>
